...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.khaled.yuv_to_png.YuvToPngPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin yuv_to_png, com.khaled.yuv_to_png.YuvToPngPlugin", e);
    }
  }
}
